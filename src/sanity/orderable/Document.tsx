...
import { AvatarCounter, Box, Button, Card, Flex, Text, Tooltip } from '@sanity/ui'
import {
  DocumentStatus,
...
export function Document({
  ...
  return (
    <PreviewCard
      ...
      // @ts-expect-error Sanity's PreviewCard accepts the structure ChildLink component at runtime.
      as={Link}
      data-as="a"
      data-ui="PaneItem"
      radius={2}
