...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'rendomatIngestState',
      title: 'Rendomat Ingest State',
      type: 'string',
      group: 'publishing',
      readOnly: true,
      hidden: true,
      options: {
        list: [
          { title: 'Ingesting', value: 'ingesting' },
          { title: 'Scheduling', value: 'scheduling' },
          { title: 'Schedule failed', value: 'scheduleFailed' },
          { title: 'Scheduled', value: 'scheduled' },
          { title: 'Ingest failed', value: 'failed' },
        ],
      },
      description: 'Internal retry state for atomic Rendomat ingest and QStash scheduling.',
    }),
    defineField({
      name: 'rendomatIngestClaim',
      title: 'Rendomat Ingest Claim',
      type: 'string',
      group: 'publishing',
      readOnly: true,
      hidden: true,
    ...
    defineField({
      name: 'rendomatIngestClaimedAt',
      title: 'Rendomat Ingest Claimed At',
      type: 'datetime',
      group: 'publishing',
      readOnly: true,
      hidden: true,
    ...
    defineField({
      name: 'rendomatScheduledAt',
      title: 'Rendomat Enqueued At',
      type: 'datetime',
      group: 'publishing',
      readOnly: true,
      hidden: true,
    ...
    defineField({
      name: 'rendomatScheduleError',
      title: 'Rendomat Schedule Error',
      type: 'text',
      rows: 3,
      group: 'publishing',
      readOnly: true,
