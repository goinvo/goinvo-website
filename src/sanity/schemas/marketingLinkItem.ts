...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: 'Research directive that justified this Quick Link.',
    }),
    defineField({
      ...
      description: 'Approved findings used to generate or justify this Quick Link.',
    }),
    defineField({
