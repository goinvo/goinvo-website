...
function EmailIcon() {
  return (
    <svg width="33" height="33" viewBox="0 0 33 33" fill="currentColor">
      <path d="M16.5,0C7.387,0,0,7.387,0,16.5C0,25.613,7.387,33,16.5,33C25.613,33,33,25.613,33,16.5C33,7.387,25.613,0,16.5,0z M25.5,22.125c0,0.621-0.504,1.125-1.125,1.125H16.5H8.625c-0.621,0-1.125-0.504-1.125-1.125v-9.408l8.375,5.601 c0.378,0.253,0.873,0.253,1.25,0l8.375-5.601V22.125z M17.125,15.351c-0.378,0.253-0.872,0.253-1.25,0L7.5,9.75h18L17.125,15.351z" />
    </svg>
  )
}
...
function LinkedInIcon() {
  return (
    <svg width="33" height="33" viewBox="0 0 33 33" fill="currentColor">
      <path d="M32.938,16.5c0,9.079-7.359,16.438-16.438,16.438S0.062,25.578,0.062,16.5c0-9.078,7.359-16.438,16.438-16.438 S32.938,7.421,32.938,16.5z M7.855,8.407c0,1.196,0.966,2.167,2.164,2.167c1.193,0,2.162-0.971,2.162-2.167S11.213,6.24,10.02,6.24 C8.821,6.24,7.855,7.211,7.855,8.407z M14.225,24.24h3.727v-5.945c0-1.57,0.296-3.09,2.236-3.09c1.914,0,1.938,1.795,1.938,3.189 v5.846h3.729v-6.594c0-3.238-0.697-5.728-4.475-5.728c-1.814,0-3.031,0.997-3.529,1.942h-0.051v-1.645h-3.576V24.24z M8.109,24.248 h3.734V12.226H8.109V24.248z" />
    </svg>
  )
}
...
function TwitterIcon() {
  return (
    <svg width="33" height="33" viewBox="0 0 33 33" fill="currentColor">
      <path d="M33,16.5C33,25.613,25.613,33,16.5,33C7.387,33,0,25.613,0,16.5C0,7.387,7.387,0,16.5,0C25.613,0,33,7.387,33,16.5z M26.791,10.826c-0.712,0.332-1.477,0.555-2.28,0.656c0.819-0.515,1.449-1.332,1.745-2.304c-0.767,0.477-1.616,0.824-2.52,1.011 c-0.725-0.81-1.757-1.315-2.898-1.315c-2.192,0-3.97,1.865-3.97,4.166c0,0.327,0.035,0.645,0.103,0.949 c-3.299-0.174-6.224-1.832-8.182-4.352c-0.342,0.615-0.538,1.331-0.538,2.094c0,1.445,0.701,2.72,1.767,3.467 c-0.651-0.021-1.263-0.209-1.798-0.521c0,0.017,0,0.035,0,0.052c0,2.018,1.368,3.702,3.184,4.085 c-0.333,0.095-0.684,0.146-1.046,0.146c-0.255,0-0.504-0.027-0.747-0.076c0.505,1.655,1.971,2.859,3.708,2.894 c-1.358,1.117-3.07,1.783-4.93,1.783c-0.32,0-0.636-0.02-0.947-0.058c1.757,1.182,3.843,1.871,6.085,1.871 c7.301,0,11.295-6.348,11.295-11.852c0-0.181-0.005-0.36-0.012-0.539C25.586,12.395,26.259,11.661,26.791,10.826" />
    </svg>
  )
}
...
function MediumIcon() {
  return (
    <svg width="33" height="33" viewBox="0 0 33 33" fill="currentColor">
      <path d="M16.5,0C7.387,0,0,7.387,0,16.5C0,25.613,7.387,33,16.5,33C25.613,33,33,25.613,33,16.5C33,7.387,25.613,0,16.5,0z M26.167,11.323h-0.732c-0.273,0-0.657,0.393-0.657,0.645v9.114c0,0.252,0.384,0.594,0.657,0.594h0.732v2.164h-6.645v-2.164h1.392 v-9.58h-0.068L17.598,23.84h-2.514l-3.206-11.744h-0.081v9.58h1.391v2.164H7.625v-2.164h0.712c0.293,0,0.679-0.342,0.679-0.594 v-9.114c0-0.252-0.385-0.645-0.679-0.645H7.625V9.16h6.956l2.284,8.499h0.062l2.305-8.499h6.935V11.323z" />
    </svg>
  )
}
...
function FlickrIcon() {
  return (
    <svg width="33" height="33" viewBox="0 0 33 33" fill="currentColor">
      <path d="M16.5,0C7.387,0,0,7.387,0,16.5C0,25.613,7.387,33,16.5,33C25.613,33,33,25.613,33,16.5C33,7.387,25.613,0,16.5,0z M10.875,20.75c-2.295,0-4.156-1.86-4.156-4.156c0-2.295,1.861-4.156,4.156-4.156s4.156,1.861,4.156,4.156 C15.031,18.89,13.17,20.75,10.875,20.75z M22.125,20.75c-2.295,0-4.156-1.86-4.156-4.156c0-2.295,1.861-4.156,4.156-4.156 s4.156,1.861,4.156,4.156C26.281,18.89,24.42,20.75,22.125,20.75z" />
    </svg>
  )
}
...
function SoundCloudIcon() {
  return (
    <svg width="33" height="33" viewBox="0 0 33 33" fill="currentColor">
      <path d="M33,16.5C33,25.613,25.613,33,16.5,33C7.387,33,0,25.613,0,16.5C0,7.387,7.387,0,16.5,0C25.613,0,33,7.387,33,16.5z M14.964,9.569v11.178c0,0.622,0.5,1.125,1.122,1.125c2.214,0,7.066,0,8.629,0c2.049-0.001,4.887-0.384,4.318-4.221 c-0.568-3.837-5.244-2.687-5.244-2.687s0.005-4.638-4.602-6.207c-1.303-0.444-2.625-0.333-3.435-0.188 C15.276,8.656,14.964,9.084,14.964,9.569z M12.703,9.381c-0.26,0.13-0.424,0.396-0.424,0.687v11.421 c0,0.424,0.344,0.768,0.768,0.768s0.767-0.344,0.767-0.768V10.067C13.813,9.497,13.213,9.125,12.703,9.381z M10.36,13.814 c-0.424,0-0.768,0.343-0.768,0.767v6.907c0,0.424,0.344,0.768,0.768,0.768s0.767-0.344,0.767-0.768v-6.907 C11.127,14.158,10.784,13.814,10.36,13.814z M7.675,12.663c-0.424,0-0.768,0.344-0.768,0.768v7.674c0,0.424,0.344,0.768,0.768,0.768 s0.768-0.344,0.768-0.768V13.43C8.442,13.006,8.099,12.663,7.675,12.663z M4.796,15.732c-0.424,0-0.768,0.344-0.768,0.768v3.453 c0,0.424,0.344,0.768,0.768,0.768s0.767-0.344,0.767-0.768V16.5C5.563,16.076,5.22,15.732,4.796,15.732z" />
    </svg>
  )
}
...
function GoInvoLogo() {
  return (
    <svg width="64" height="35" viewBox="0 0 64 35" fill="currentColor">
