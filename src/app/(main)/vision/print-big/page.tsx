...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    images: ['/images/features/print-big/hero.jpg'],
  },
}
  ...
  return (
    <div className="print-big pt-[var(--spacing-header-height)]">
      ...
      <section className="print-big__section">
        <div className="print-big__inline-pix">
          ...
          <img
            ...
            className="tall-boy"
            src="/images/features/print-big/crane-delivery.jpg"
          />
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            alt="Epson P20000 printer hoisted in the sky by a crane"
            className="tall-boy"
            src="/images/features/print-big/crane-delivery-2.jpg"
          />
        </div>
      ...
      <section className="print-big__section">
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img alt="Large scale design of the Standard Health Record ecosystem" src="/images/features/print-big/point-1.jpg" />
      </section>
      ...
      <section className="print-big__section">
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img alt="A smiling woman kneels infront of a wall filled with large scale design print-outs" src="/images/features/print-big/point-2.jpg" />
      </section>
      ...
      <section className="print-big__section">
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img alt="A designer and client's huddle around a table with a large scale design print-out, pointing to areas of the design" src="/images/features/print-big/point-3.jpg" />
      </section>
      ...
      <section className="print-big__section">
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img alt="Invo's Care Cards printed as large posters, hung up in various areas of the doctor's office." className="tall-boy" src="/images/features/print-big/point-4.jpg" />
      </section>
      ...
      <section className="print-big__section">
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img alt="Overhead shot of Invo artwork printed very large, spread out on the floor with the studio team scattered around smiling" src="/images/features/print-big/point-5.jpg" />
      </section>
      ...
      <section className="print-big__section">
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img alt="Invo team members having fun displaying their 'Healthcare is a Human Right' large-scale print-out on the floor" className="tall-boy" src="/images/features/print-big/end.jpg" />
      </section>
