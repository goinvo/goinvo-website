...
import refs from '@/data/vision/physician-burnout/references.json'

export const metadata: Metadata = {
  title: 'Physician Burnout: The Silent Killer',
  description:
    'Physician burnout is a public health crisis worsening by the day. To turn the tide, some changes must be made.',
}

export default function PhysicianBurnoutPage() {
  return (
    <div>
      <SetCaseStudyHero image={cloudfrontImage('/images/features/burnout/hero.jpg')} />
      ...
      <section className="py-12">
        <div className="max-width max-width-md content-padding mx-auto">
          ...
          <p className="leading-relaxed mb-4">
            ...
            average
            <sup><a href="#references">19</a></sup>
          ...
          <h2 className="font-serif text-2xl mt-12 mb-2">
          ...
          <p className="leading-relaxed mb-4">
            ...
            US healthcare workforce. With the Covid-19 global pandemic making
          ...
          {/* Chart 1: National Burnout Rate */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div>
              <Image
                src={cloudfrontImage('/images/features/burnout/chart-national-burnout-3.jpg')}
                alt="National Burnout Rate chart"
                width={800}
                height={600}
            ...
            <div>
              <h3 className="header-md mt-0 mb-2">
          ...
          {/* Chart 2: Depression & Suicide Report */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div>
              <Image
                src={cloudfrontImage('/images/features/burnout/chart-depression-suicide.jpg')}
                alt="Depression and Suicide Report chart"
                width={800}
                height={600}
                className="w-full h-auto"
              />
          ...
          {/* Chart 3: Burnout in Academic Physicians */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div>
              <Image
                src={cloudfrontImage('/images/features/burnout/chart-academic-burnout-3.jpg')}
                alt="Burnout in Academic Physicians chart"
                width={800}
                height={600}
                className="w-full h-auto"
              />
          ...
          {/* Chart 4: Physicians with Symptoms */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div>
              <Image
                src={cloudfrontImage('/images/features/burnout/chart-physicians-symptoms.jpg')}
                alt="Physicians with Symptoms chart"
                width={800}
                height={600}
                className="w-full h-auto"
              />
          ...
          <p className="leading-relaxed mb-4">
            ...
            optimistic conclusions are premature. It concluded &ldquo;burnout and
            ...
            way.&rdquo; As of 2016 there were over <strong>950,000</strong>{' '}
          ...
          <p className="leading-relaxed mb-4">
            ...
            <sup><a href="#references">10,14</a></sup>{' '}
          ...
          <h2 className="font-serif text-2xl mt-12 mb-2">
            ...
            <sup><a href="#references">14,15</a></sup>
          </h2>
          <p className="leading-relaxed mb-4">
      ...
      {/* Contributors - Mobile list + image */}
      <section>
        <div className="lg:hidden">
          <div className="max-width max-width-md content-padding mx-auto">
            <ol className="list-decimal list-outside pl-6 space-y-3 mb-8">
              <li>
              ...
              <li>
                ...
                world practice and external pressures &mdash; profits over
                patients
              </li>
            </ol>
          </div>
          <Image
            src={cloudfrontImage('/images/features/burnout/contributors-mobile.jpg')}
        ...
        {/* Contributors - Desktop image (has text baked in) */}
        <div className="hidden lg:block">
          <Image
            src={cloudfrontImage('/images/features/burnout/contributors-desktop-2.jpg')}
      ...
      <section className="py-12">
        <div className="max-width max-width-md content-padding mx-auto">
          ...
          <h3 className="header-md mt-8 mb-0">
            Organization-oriented approaches for better interventions
          </h3>
          <p className="leading-relaxed mb-4">
            The term &ldquo;burnout&rdquo; itself and its medicalization is problematic
          ...
          <p className="leading-relaxed mb-4">
            ...
            optimize billing and maximize reimbursement &mdash; not for patient
            care. Yet healthcare technology continues to &ldquo;innovate&rdquo; at
      ...
      {/* Vision Image */}
      <Image
        src={cloudfrontImage('/images/features/burnout/vision.jpg')}
        alt="Vision for reducing physician burnout"
        width={1600}
        height={900}
        className="w-full h-auto"
      />
      ...
      <section className="py-12">
        <div className="max-width max-width-md content-padding mx-auto">
          ...
          <Author name="Meghana Karande" company="GoInvo" />
