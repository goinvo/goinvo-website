      ...
      <div className="determinants-of-health">
          ...
          <div className="max-width max-width--md content-padding">
            ...
            <div>
              <div className="pure-u-1 pure-u-lg-1-3 pad-right--only-lg pad-top">
                <img
                  src={cloudfrontImage('/images/features/determinants-of-health/determinants-of-health-mitre-poster.jpg')}
                  className="image--max-width"
                  alt="Determinants of Health at MITRE"
                />
              </div>
              <div className="pure-u-1 pure-u-lg-1-3 pad-right--only-lg pad-top">
                <img
                  src={cloudfrontImage('/images/features/determinants-of-health/determinants-of-health-sxsw-poster3.jpg')}
                  className="image--max-width"
                  alt="Determinants of Health at SXSW"
                />
              </div>
              <div className="pure-u-1 pure-u-lg-1-3 pad-right--only-lg pad-top">
                <img
                  src={cloudfrontImage('/images/features/determinants-of-health/determinants-of-health-studio-poster.jpg')}
                  className="image--max-width"
                  alt="Determinants of Health in Studio"
                />
              </div>
            </div>
        ...
        <div className="pad-vertical--double">
          <div className="max-width max-width--md content-padding">
            ...
            <img
              src={cloudfrontImage('/images/features/determinants-of-health/sdoh-spend-mockup.jpg')}
              className="image--max-width margin-top--half"
              alt="SDOH Spend Comparison"
            />
            <div className="button-group">
              <div className="pure-u-1 pure-u-lg-1-2">
                <a
          ...
          <div className="max-width max-width--md content-padding">
            <div>
              ...
              <Author
                name="Hrothgar"
                company="GoInvo"
                image={cloudfrontImage('/images/features/determinants-of-health/headshot-hrothgar.jpg')}
              >
              ...
              <Author
                ...
                image={cloudfrontImage('/images/features/determinants-of-health/headshot-kelsey-kittelsen.jpg')}
              >
