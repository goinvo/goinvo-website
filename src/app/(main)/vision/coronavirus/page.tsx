...
const references = [
  {
    ...
    link: 'https://www.cnn.com/2020/01/28/health/coronavirus-us-masks-prevention-trnd/index.html',
  },
  {
    title:
      'Bruce, M. (2020, January 31). 2019 Novel Coronavirus Response at the Brigham: 5 Things to Know',
    link: 'https://bwhbulletin.org/2020/01/30/2019-novel-coronavirus-response-at-the-brigham-5-things-to-know/',
  },
  {
    title:
    ...
    link: 'https://web.archive.org/web/20200205084838/https://www.cdc.gov/coronavirus/2019-ncov/about/prevention-treatment.html',
  },
  {
    title:
    ...
    link: 'https://web.archive.org/web/20200131050853/https://www.cdc.gov/coronavirus/2019-ncov/about/steps-when-sick.html',
  },
  {
    title:
    ...
    link: 'https://web.archive.org/web/20200131032657/https://www.cdc.gov/coronavirus/2019-ncov/hcp/guidance-prevent-spread.html#steps-for-caregivers',
  },
  {
    title:
      'Centers for Disease Control and Prevention. (2020, January 29). How 2019-nCoV Spreads. Retrieved February 6 2020. (archived link)',
    link: 'https://web.archive.org/web/20200206092803/https://www.cdc.gov/coronavirus/2019-ncov/about/transmission.html',
  },
  {
    title:
  ...
  },
  {
    ...
    link: 'http://www.nejm.org/doi/full/10.1056/NEJMoa2001316?query=featured_home',
  },
  {
    title:
    ...
    link: 'https://web.archive.org/web/20200306204414/https://www.dhhs.nh.gov/dphs/cdcs/sars/documents/sarsplan.pdf',
  },
  {
    title:
      'Pappas, S. (2020, February 4). Will airport screenings be enough to stop coronavirus in the US? Retrieved February 6, 2020.',
    link: 'https://www.livescience.com/can-airport-screening-stop-coronavirus.html',
  },
  {
    title:
      'Shenoy, E. (2020, January 24). Monitoring coronavirus. Retrieved February 1, 2020. (original source no longer available)',
    link: 'https://www.massgeneral.org/news/hotline/HTL012420/monitoring-coronavirus',
  },
  {
    title:
    ...
    link: 'https://time.com/5780049/coronavirus-quarantines-united-states/',
  },
  {
    title:
    ...
    link: 'https://www.usatoday.com/story/travel/2020/02/07/coronavirus-u-s-passenger-screenings-11-airports/4693589002/',
  },
  {
    title:
    ...
    link: 'https://www.statnews.com/2020/02/07/hospitals-harnessing-resources-brace-spike-coronavirus-cases/',
  },
  {
    title:
  ...
  },
  {
    ...
    link: 'https://web.archive.org/web/20200211031759/https://www.cdc.gov/coronavirus/2019-nCoV/summary.html?CDC_AA_refVal=https%3A%2F%2Fwww.cdc.gov%2Fcoronavirus%2F2019-ncov%2Fabout%2Fwhat-you-should-do.html#anchor_1580064337377',
  },
  {
    title:
  ...
  },
  {
    ...
    link: 'https://web.archive.org/web/20200404053838/https://www.cdc.gov/coronavirus/2019-ncov/prevent-getting-sick/diy-cloth-face-coverings.html',
  },
]
      ...
      <div className="coronavirus pt-[var(--spacing-header-height)]">
        ...
        <section>
          <div className="max-width content-padding">
            ...
            <img
              ...
              alt="China's COVID-19 death rate by age"
            />
            <p>
          ...
          <div className="max-width content-padding">
            ...
            <div className="hidden--lg">
              <img
                ...
                className="image--max-width"
                alt="Illustration of a hand holding a child's hand."
              />
              ...
              <img
                ...
                className="image--max-width"
                alt="Illustration of a person sneezing."
              />
        ...
        <section>
          ...
          <div
            ...
            style={{
              backgroundImage: `url(${cloudfrontImage(
          ...
          <div className="hidden--lg">
            <img
              ...
              className="image--max-width"
              alt="An illustration of a local ground team working together to manage the outbreak."
            />
            <div className="max-width content-padding">
              <NumberListItem number="1">
          ...
          <img
            ...
            className="image--max-width"
            alt="A comic about how we protect our airports and borders."
          />
          <div className="max-width content-padding">
          ...
          <img
            ...
            className="image--max-width"
            alt="A comic about how hospitals respond to quarantine."
          />
          <div className="max-width content-padding">
            <div className="text--center margin-bottom--quad">
              <a
          ...
          <div className="max-width content-padding">
            <p>
              ...
              centers&rdquo; in the US —meaning that they have expert knowledge in
          ...
          <img
            ...
            className="image--max-width"
            alt="A comic about how a city would respond to quarantine."
          />
          <div className="max-width content-padding">
            <div className="text--center margin-bottom--quad">
              <a
