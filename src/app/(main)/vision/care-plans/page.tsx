      ...
      <section className="bg-white py-8 border-b border-gray-200">
        <div className="max-width max-width-md content-padding mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
            ...
            <a href="#part2" className="font-semibold text-primary hover:underline">Part 2: Landscape</a>
            <a href="#part3" className="font-semibold text-primary hover:underline">Part 3: Future</a>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8" id="part1">
            ...
            <div id="part2">
              <Image
                ...
                className="w-full h-auto mb-4 rounded"
              />
              <h3 className="font-serif text-xl mb-2">Part 2: Landscape</h3>
              <p className="text-gray text-sm leading-relaxed">
            ...
            <div id="part3">
              <Image
                ...
                className="w-full h-auto mb-4 rounded"
              />
              <h3 className="font-serif text-xl mb-2">Part 3: Future</h3>
              <p className="text-gray text-sm leading-relaxed">
