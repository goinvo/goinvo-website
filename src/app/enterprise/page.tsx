    ...
    <div className="pt-[var(--spacing-header-height)]">
      ...
      <section className="bg-primary-lightest py-16">
        <div className="max-width content-padding text-center">
          ...
          {/* 3M Case Study */}
          <Link href="/work/3m-coderyte" className="block bg-white  overflow-hidden shadow-card hover:shadow-card-hover transition-shadow mb-8 text-left">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8 lg:p-12">
                ...
                <p className="text-primary mt-4">Read Case Study</p>
              </div>
          ...
          <Link href="/work/infobionic-heart-monitoring" className="block bg-white  overflow-hidden shadow-card hover:shadow-card-hover transition-shadow text-left">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8 lg:p-12">
                <h3 className="font-serif text-2xl mb-4">
