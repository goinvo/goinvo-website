          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <div className="flex flex-col gap-1">
                <a href="https://www.goinvo.com/features/from-bathroom-to-healthroom/" className="text-primary text-sm">
                  From bathroom to healthroom
                </a>
                <Link href="/work/wuxi-nextcode-familycode" className="text-primary text-sm">
                  WuXi NextCODE
                </Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <Link href="/work?category=open-source" className="text-primary text-sm">
