    ...
    <div className="pt-[var(--spacing-header-height)]">
      ...
      <section className="bg-primary-lightest py-16">
        <div className="max-width content-padding text-center">
          ...
          <Link href="/work/mass-snap" className="block bg-white  overflow-hidden shadow-card hover:shadow-card-hover transition-shadow mb-8 text-left">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8 lg:p-12">
                ...
                <p className="text-primary">Read Case Study</p>
              </div>
          ...
          <Link href="/work/all-of-us" className="block bg-white  overflow-hidden shadow-card hover:shadow-card-hover transition-shadow mb-8 text-left">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8 lg:p-12">
                <h3 className="font-serif text-2xl mb-4">
          ...
          <Link href="/work/ahrq-cds" className="block bg-white  overflow-hidden shadow-card hover:shadow-card-hover transition-shadow mb-8 text-left">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8 lg:p-12">
                <h3 className="font-serif text-2xl mb-4">
