  ...
  return (
    <div className="pt-[var(--spacing-header-height)]">
      ...
      <section
        ...
        style={{ backgroundImage: `url(${cloudfrontImage('/images/open_source/open-source-bgd.png')})` }}
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {conversations.map((item) => (
              <a
                ...
                className="group block p-6 bg-gray-light hover:shadow-card-hover transition-shadow"
              >
