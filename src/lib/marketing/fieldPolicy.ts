...
export const MARKETING_FIELDS: Record<ManagedMarketingType, readonly string[]> = {
  ...
  marketingOrder: ['orderNumber', 'status', 'placedAt', 'items', 'subtotal', 'shipping', 'donation', 'tax', 'total', 'currency', 'contact', 'customerName', 'customerEmail', 'shippingAddress', 'processor', 'processorPaymentId', 'paymentUrl', 'campaign', 'utmSource', 'utmMedium', 'utmCampaign', 'notes'],
