...
export const MARKETING_FIELDS: Record<ManagedMarketingType, readonly string[]> = {
  ...
  marketingPerformanceSignal: ['title', 'provider', 'status', 'signalType', 'sourceLabel', 'query', 'pageUrl', 'experiment', 'campaign', 'channel', 'linkItem', 'calendarItem', 'researchProject', 'metricDate', 'periodStart', 'periodEnd', 'metrics', 'variantEngagement', 'interpretation', 'recommendation', 'rawImport'],
  ...
  marketingProduct: ['title', 'slug', 'sourceVisualization', 'status', 'kind', 'description', 'image', 'featured', 'displayOrder', 'sku', 'production', 'orderable', 'trackInventory', 'inventoryQuantity', 'lowStockThreshold', 'allowBackorder', 'price', 'currency', 'checkoutUrl', 'stripeProductId', 'stripePriceId', 'stripePriceUnitAmount', 'stripePriceCurrency', 'stripeSyncedAt', 'campaign', 'audiences', 'notes'],
