...
export const MARKETING_FIELDS: Record<ManagedMarketingType, readonly string[]> = {
  ...
  marketingIdea: ['title', 'summary', 'category', 'status', 'priority', 'effort', 'nextAction', 'relatedUrl', 'source', 'needsReview'],
  ...
  marketingProduct: ['title', 'slug', 'sourceVisualization', 'status', 'kind', 'description', 'image', 'featured', 'displayOrder', 'sku', 'production', 'orderable', 'trackInventory', 'inventoryQuantity', 'lowStockThreshold', 'allowBackorder', 'price', 'compareAtPrice', 'currency', 'checkoutUrl', 'stripeProductId', 'stripePriceId', 'stripePriceUnitAmount', 'stripePriceCurrency', 'stripeSyncedAt', 'campaign', 'audiences', 'notes'],
  marketingOrder: ['orderNumber', 'status', 'placedAt', 'items', 'subtotal', 'shipping', 'donation', 'tax', 'total', 'currency', 'contact', 'customerName', 'customerEmail', 'shippingAddress', 'processor', 'processorPaymentId', 'paymentUrl', 'campaign', 'utmSource', 'utmMedium', 'utmCampaign', 'notes', 'livemode', 'processorChargeId', 'settlementState', 'amountCaptured', 'amountRefunded', 'amountDisputeHeld', 'amountLostToDispute', 'netCollected', 'ledgerSyncedAt', 'ledgerSyncError'],
  ...
  marketingShopSettings: ['storeName', 'headline', 'description', 'storefrontEnabled', 'supportEmail', 'shippingFlatRate', 'provider', 'connectionStatus', 'accountLabel', 'dashboardUrl', 'webhookStatus', 'syncContacts', 'contactSegment', 'contactSourceNote'],
