...
export const MARKETING_FIELDS: Record<ManagedMarketingType, readonly string[]> = {
  ...
  marketingLeadMagnet: ['title', 'slug', 'status', 'description', 'articlePath', 'gatedAsset', 'emailOctopusTag', 'offerKey', 'createOutreachContacts'],
}
